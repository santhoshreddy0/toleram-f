  ...
  return (
    <div className="rounded-lg bg-gray-900 p-6 border border-gray-800 shadow-lg">
      <div className="flex items-center mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">Super12 Team Name</h3>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-gray-400 flex items-center">
          ...
          We'll display this on the leaderboard
        </p>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-gray-800">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400 mb-4">
            A great team name shows your opponents what you're made of!
          </p>
          ...
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
            ...
            <span>Make your team name legendary!</span>
          </div>
        </div>
      </div>
    </div>
