...
const BettingHistory =({allBets})=>{
    return(<div className="lg:col-span-2 bg-gray-800 rounded-lg p-6 shadow">
                ...
                >
                  ...
                  <td className="px-6 py-4 tracking-tight">
                    {bet.result === "Won" ? (
                      ...
                      <span className="bg-yellow-900 text-yellow-300 px-2 py-1 rounded text-xs w-16 text-center">
                        Pending
                      </span>
                    )}
                  </td>
