...
export default function AdminMatches() {
  ...
  return (
    <div className="py-8">
            ...
            {matches?.matches.length === 0 ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-6">
                {matches?.matches.map((match) => (
                  <article
                    key={match.id}
                    className="relative flex flex-col items-start justify-between bg-gray-800 rounded-lg"
                  >
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex flex-col items-center">
                            <div class="vs flex justify-center align-middle">
                              <img
                                src="/vs.png"
                                alt="VS"
                                class="vs-image w-16"
      ...
      {open && (
        <CreateNewMatch open={open} setOpen={setOpen} matchId={matchId} />
      )}
    </div>
  );
}
