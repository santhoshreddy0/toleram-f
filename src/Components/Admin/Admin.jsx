              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={(e) =>
                      setMatchData({ ...matchData, teamOneId: e.target.value })
                    }
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setMatchData({ ...matchData, teamTwoId: e.target.value })
                    }
                  />
                </div>
                <div className="grid grid-cols-3 gap-4">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setMatchData({ ...matchData, canBet: e.target.checked })
                      }
                    />
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMatchData({ ...matchData, betStatus: e.target.value })
                    }
                  >
            ...
            <form onSubmit={(e) => handleSubmit(e, "team")}>
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  value={teamData.logo}
                  onChange={(e) =>
                    setTeamData({ ...teamData, logo: e.target.value })
                  }
                />
                <textarea
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTeamData({ ...teamData, question: e.target.value })
                  }
                />
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setTeamData({ ...teamData, canShow: e.target.checked })
                    }
                  />
                  <label className="text-gray-100">Can Show</label>
                </div>
                <textarea
                  ...
                  onChange={(e) =>
                    setTeamData({ ...teamData, options: e.target.value })
                  }
                />
                <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                  Create Team
