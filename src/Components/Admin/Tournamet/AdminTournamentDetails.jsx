    ...
    return (
        <div className="">
            <div className="pt-8 px-4 sm:px-8">
                <p className="text-gray-200 text-2xl font-medium mb-6">{round?.round.round_name}</p>
            ...
            {open && <CreateNewQuestionPopup open={open} setOpen={setOpen} round={round.round} question={question} />}
        </div>
    )
}