      ...
      <div className="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none relative sm:h-full relative">
        ...
        />
          <div className="absolute right-0 top-0">
            <div className="flex items-center justify-center bg-gray-500 rounded-lg px-3 py-2">
            <XMarkIcon className="w-5 h-5 text-white" />
            <button
              type="button"
              onClick={closePopupHandler}
              className="inline-flex items-center rounded-md text-md font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              close
            </button>
            </div>
